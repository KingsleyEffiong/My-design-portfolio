  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-5 w-[350px]">
            ...
            <p className="text-xs text-[var(--light-gray)]">I am an Innovative frontend web developer with expertise in Javascript, React, Next Js, Vite, Firebase, and
Tailwind CSS. Skilled in building interactive web applications, integrating real-time database features in any
